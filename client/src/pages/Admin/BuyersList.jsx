...
import { getAllBuyers } from '../../api/admin';
...
export const BuyersList = () => {
  ...
  const fetchBuyers = async (page = 1, search = '', sort = 'createdAt', order = 'desc') => {
    try {
      setLoading(true);
      setError(null);
      const response = await getAllBuyers(page, search, 20, sort, order);
  ...
  useEffect(() => {
    fetchBuyers(currentPage, searchTerm, sortBy, sortOrder);
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage and monitor all registered buyers</p>
            </div>
            <Link
              to="/admin"
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-bold text-gray-900">{pagination.totalBuyers || 0}</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-bold text-gray-900">
                  {buyers.filter(buyer => buyer.activeParticipations > 0).length}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-bold text-gray-900">
                  {buyers.reduce((sum, buyer) => sum + (buyer.totalBids || 0), 0)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-bold text-gray-900">
                  {buyers.reduce((sum, buyer) => sum + (buyer.wonAuctions || 0), 0)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-end">
              <div className="text-sm text-gray-600">
                {pagination.totalBuyers ? `${pagination.totalBuyers} total buyers` : ''}
              </div>
            </div>
          </div>
        </div>
                        ...
                        <div className="text-sm text-gray-900">
                          <div className="flex space-x-4">
                            ...
                            <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">
                              {buyer.activeParticipations || 0} Active
                            </span>
                            <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs">
                              {buyer.wonAuctions || 0} Won
                            </span>
                          </div>
                        </div>
                      </td>
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    to{' '}
                    <span className="font-medium">
                      {Math.min(currentPage * pagination.limit, pagination.totalBuyers)}
                    </span>{' '}
                    of{' '}
                    <span className="font-medium">{pagination.totalBuyers}</span>{' '}
                    results
                  </p>
                </div>
                <div>
